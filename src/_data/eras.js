/* The timeline on Our Story. Every entry names what it rests on: sources are
   inline, not collected in a footnote. Where a date is contested or
...
export default [
  ...
  },
  {
    ...
    body: 'A rail line built through the valley set the location of the town site. The plat was recorded in 1875, laid out along the tracks. That survey is why the street grid runs as it does, at an angle to the later county road pattern.',
  },
  {
    when: 'Late 1800s onward',
    source: 'Standing buildings; county records',
